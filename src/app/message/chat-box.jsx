      ...
      <div className="container mx-auto h-screen p-4">
        ...
        {currentGroup && (
          <div className="rounded-lg border border-stroke p-6 dark:border-form-strokedark dark:bg-form-input">
            ...
            <div
              className="dark:bg-gray-900 mb-4 h-64 overflow-y-auto rounded-lg bg-white p-4  
            dark:bg-[#181818]"
            >
            ...
            <form onSubmit={handleFormSubmission} className="flex space-x-4">
              <input
                ...
                className="w-full rounded-lg border border-stroke bg-white p-4 outline-none 
              ...
              <button
                ...
                className="disabled:bg-gray-400 flex items-center justify-center rounded-lg bg-primary px-6 py-3 
                text-white transition hover:bg-opacity-90 disabled:cursor-not-allowed"
              >
