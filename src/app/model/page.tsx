    ...
    try {
      const response = await fetch(invokeUrl, {
        ...
        headers: {
          ...
          Origin: "http://localhost:3000/model",
        },
    ...
    <DefaultLayout>
      ...
      <div className="grid grid-cols-1 gap-9 sm:grid-cols-3">
        <div className="flex flex-col gap-9 sm:col-span-2">
          <div
            className="rounded-lg border border-stroke bg-white shadow-default dark:border-[#121212] 
          dark:bg-[#181818]"
          >
                ...
                <div className="mb-4.5 flex flex-col gap-6 xl:flex-row">
                  <div className="w-full xl:w-1/2">
                    ...
                    <input
                      ...
                      outline-none transition focus:border-primary active:border-primary dark:border-gray-2 
                      dark:bg-[#181818] dark:text-white dark:focus:border-primary"
                    />
                  </div>
                  ...
                  <div className="w-full xl:w-1/2">
                    ...
                    <input
                      ...
                      className="w-full rounded-lg border-[1.5px] bg-transparent px-5 py-3 text-black outline-none
                      transition focus:border-primary active:border-primary dark:border-gray-2 
                      dark:bg-[#181818] dark:text-white dark:focus:border-primary"
                    />
                  </div>
                </div>
        ...
        <div className="flex flex-col gap-9">
          <div
            className="rounded-lg border border-stroke bg-white p-3 shadow-default dark:border-[#121212]
          dark:bg-[#181818]"
          >
            <h3 className="font-medium text-black dark:text-white">
