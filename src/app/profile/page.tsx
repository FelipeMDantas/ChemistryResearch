  ...
  return (
    <DefaultLayout>
      <div className="mx-auto max-w-242.5">
        ...
        <div className="overflow-hidden rounded-lg border border-stroke bg-white shadow-default 
        dark:border-strokedark dark:bg-boxdark">
          ...
          <div className="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
            <div className="relative z-30 mx-auto -mt-22 h-10 w-full rounded-full bg-white/20 p-1 
            backdrop-blur sm:h-44 sm:max-w-44 sm:p-3">
              <div className="relative drop-shadow-2">
                <Image
                  src={user.photo}
                  width={160}
                  className="rounded-full object-cover max-h-40 min-w-40"
                  height={160}
                  style={{
                    width: "auto",
                    height: "auto",
